...
const LeadsAI = () => {
  return (
    <div className={ styles.pageWrapper } dir="rtl">
      <Head>
        <title>AI Lead Qualification System in 7 Days | First Choice AI | AI Automation & AI Agent Implementation for Small Businesses | Aylon Spigel</title>
        <meta name="description" content="Build custom AI systems that automatically qualify every inbound lead. We build AI systems that automate lead handling, customer responses, and workflows" />
      </Head>
