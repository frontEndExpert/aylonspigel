    ...
    return <>
        {(
            <App title="AylonSpigel.com - Privacy Policy"
                description="Our pring online shopping experience." >
                <div className={styles.headbox} >
                    <h1 className={styles.bigheader}>Privacy Policy</h1>
                    <h2>Here at <b>AylonSpigel.com</b> we value your privacy. </h2>
                    ...
                    <p>In the future we may use third party advertisements on <b>AylonSpigel.com</b>. Some of these advertisers may use technology such as cookies when they advertise on our site, which will also send these advertisers (such as Google through the Google AdSense program) information including your IP address, your ISP, the browser you used to visit our site, and in some cases, whether you have Flash installed. This is generally used for geo-targeting purposes (showing ads relevant to your locality) or showing certain ads based on specific sites visited (such as showing cooking ads to someone who frequents cooking sites).</p>
                    ...
                    <p>AylonSpigel.com is a general audience site and does not knowingly collect any personal information from children. While our website may be viewed by children, we do not wish to receive data from children. <b>AylonSpigel.com</b> encourages parents and guardians to spend time online with their children and to participate in the interactive activities offered on the sites their children visit. No information should be submitted to, or posted at, the <b>AylonSpigel.com</b> web site by visitors under 18 years of age without the consent of their parent or guardian.
                    </p>
                    <h2>Links to Third Party Sites:</h2>
                    <p>This website may contain links to other web sites that are not controlled by <b>AylonSpigel.com</b> (&quot;Third Party Sites&quot;). Please be aware that we are not responsible for the privacy practices of such other sites. We encourage our users to be aware when they leave our site and to read the privacy statements of each and every website that collects personally identifiable information. The <b>AylonSpigel.com</b> Privacy Policy applies solely to information collected by this website.
                    </p>
                    <h2>Changes to this Privacy Policy:</h2>
                    <p>AylonSpigel.com will occasionally update this privacy policy. For material changes to this statement, <b>AylonSpigel.com</b> will notify our users by placing prominent notice on the site.</p>
                    <p>Enforcement of this Privacy Policy and Contact Information:</p>
                    <p>AylonSpigel.com welcomes your comments regarding our privacy policy. For any comments, feel free to contact us via our &quot;Contact Us&quot; page.</p>
                </div>
            </App>
        )}
    </>
