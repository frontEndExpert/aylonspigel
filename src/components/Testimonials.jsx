          ...
          <div className="flex items-start space-x-4">
            ...
            <div className="flex-1">
              <blockquote className="text-black leading-relaxed mb-4" style={{color: 'black !important'}}>
                <p className="text-lg italic text-left" style={{fontSize: '18px !important', color: 'black !important'}}>&quot;{testimonials.text}&quot;</p>
              </blockquote>
      ...
      <div className="w-full px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-8 sm:mb-12 lg:mb-16">
            ...
            <p className="text-base sm:text-lg lg:text-xl text-white max-w-3xl mx-auto leading-relaxed">
              {data?.subtitle}
            </p>
            ...
            <div className="bg-white rounded-2xl p-6 sm:p-8 shadow-lg border border-gray-100">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
                <div className="text-center">
                  ...
                  <h4 className="text-base font-semibold text-brand-primary-dark mb-2">{data?.proven}</h4>
                  <p className="text-sm text-gray-600">{data?.delivering}</p>
                </div>
                <div className="text-center">
                  <div className="w-12 h-12 bg-gradient-to-r from-brand-secondary to-brand-accent rounded-full flex items-center justify-center mx-auto mb-4">
                    <svg className="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <h4 className="text-base font-semibold text-brand-primary-dark mb-2">{data?.fast}</h4>
                  <p className="text-sm text-gray-600">{data?.quick}</p>
                </div>
                <div className="text-center">
                  <div className="w-12 h-12 bg-gradient-to-r from-brand-secondary to-brand-accent rounded-full flex items-center justify-center mx-auto mb-4">
                    <svg className="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <h4 className="text-base font-semibold text-brand-primary-dark mb-2">{data?.personal}</h4>
                  <p className="text-sm text-gray-600">{data?.dedicated}</p>
                </div>
              </div>
            </div>
          </div>
